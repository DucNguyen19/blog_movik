  ...
  const items = [
    {
      icon: (
        <>
          <svg className="customIcon" viewBox="0 0 24 24">
            <path
    ...
    },
    {
      ...
      label: (
        <div className="font-semibold group flex justify-between relative">
          ...
          <div className="hidden group-hover:block z-50" onClick={gotoSite}>
            <ExportOutlined />
          </div>
        </div>
      ),
      ...
      <Layout className="!min-h-screen flex">
                      ...
                      <div className="cursor-pointer">
                        <Badge color="green" dot>
                          <Avatar
                            ...
                            className="bg-white border-[1px] border-[#ebeef0] "
                          />
                        </Badge>
        ...
        <div className="!flex-1 bg-white">
          <Layout className="h-full">
            <Content>
              <div className="bg-white h-full px-20">{children}</div>
            </Content>
          </Layout>
        </div>
      </Layout>
